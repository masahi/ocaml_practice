...
module GenFA1 = GenGE(GenFA_F) ;;

let resFA1 = instantiate GenFA1.gen ;;
let rFA1 = runit {pf =  resFA1 } ;;

let _ =
  print_code Format.std_formatter resFA1; print_newline()
